...
public: 
    ...
    public: 
        ...
        inline const_iterator(const iterator &itr) noexcept : m_ptr(itr.m_ptr) 
        { 
        } 
...
public: 
    ...
    { 
        return details::biops<details::expr_plus_t, result_t, result_t>(details::expr_plus, result_t(*this), result_s<T>(other)); 
    } 
    template <typename T, enable_arith_type_t<T> * = nullptr> 
    auto operator-(const T &other) const 
    { 
