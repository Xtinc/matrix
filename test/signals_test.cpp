...
public:
    ...
    MultiGaussianDistribution<1> rand;
    std::vector<double> datas1;
    std::vector<double> datas2;
};

TEST_F(SIG_TestCase, FIRFilter_LP)
{
...
TEST_F(SIG_TestCase, FIRFilter_HP)
{
...
TEST_F(SIG_TestCase, FIRFilter_BS)
{
...
TEST_F(SIG_TestCase, IIRFilter_LP)
{
...
TEST_F(SIG_TestCase, IIRFilter_HP)
{
...
TEST_F(SIG_TestCase, IIRFilter_BS)
{
...
TEST_F(SIG_TestCase, IIRFilter_BP)
{
